...
(function(window) {
	...
	jQuery.get(getRelativePath("../page/hystrix/components/hystrixThreadPool/templates/hystrixThreadPool.html"), function(data) {
		htmlTemplate = data;
	});
	jQuery.get(getRelativePath("../page/hystrix/components/hystrixThreadPool/templates/hystrixThreadPoolContainer.html"), function(data) {
