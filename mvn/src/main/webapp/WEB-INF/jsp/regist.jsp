    ...
    <div class="m-login-bg">
			<div class="m-login">
				...
				<div class="m-login-warp">
					<form class="layui-form" name="loginform" action="<%=basePath%>user/registUser.do" method="post">
						...
						<div class="layui-form-item m-login-btn">
							<div class="layui-inline">
								<button class="layui-btn layui-btn-normal" lay-submit lay-filter="login" lay-filter="loginButton">注册</button>
							</div>
							<div class="layui-inline">
								<button type="reset" class="layui-btn layui-btn-primary" onclick="login()">已有账号？</button>
							</div>
						</div>
					</form>
				</div>
